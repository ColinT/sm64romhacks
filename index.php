	...
	<body>		<div class="container">
			...
			<div align="center">
				...
				<?php foreach($newsposts as $newspost) { 
					...
					$edit = ($_SESSION['logged_in'] && in_array($user_id, ADMIN_NEWS) && $user_id == $author_id) ? "<a class='btn btn-info text-nowrap' href='/news/editNewspost.php?id=$newspost_id'><img src=\"/_img/edit.svg\"></a>" : "&nbsp;";
					...
					$delete = ($_SESSION['logged_in'] && in_array($user_id, ADMIN_SITE)) ? "<a class='btn btn-danger text-nowrap' href='/news/deleteNewspost.php?id=$newspost_id'><img src=\"/_img/delete.svg\"></a>" : "&nbsp;";
