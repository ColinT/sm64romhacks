	...
	<body>		<div class="container">
			...
			<div align="center">
				...
				if($_SESSION['logged_in'] && in_array($user_id, ADMIN_NEWS)){
					print("<a href=\"addNews.php\" class=\"btn btn-primary\">Add Newspost!</a><br/><br/>");
				}
				?>
				...
				<?php foreach($newsposts as $newspost) { 
					...
					$edit = ($_SESSION['logged_in'] && in_array($user_id, ADMIN_NEWS) && $user_id == $author_id) ? "<a class='btn btn-primary text-nowrap' href='editNewspost.php?id=$newspost_id'>Edit Newspost</a>" : "&nbsp;";
					...
					$delete = ($_SESSION['logged_in'] && in_array($user_id, ADMIN_SITE)) ? "<a class='btn btn-danger text-nowrap' href='deleteNewspost.php?id=$newspost_id'>Delete Newspost</a>" : "&nbsp;";
